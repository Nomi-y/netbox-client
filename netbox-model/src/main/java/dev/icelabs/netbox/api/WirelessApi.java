...
public interface WirelessApi {
    ...
    Call<WirelessLANGroup> wirelessWirelessLanGroupsPartialUpdate(
            @retrofit2.http.Path("id") Integer id,
            @retrofit2.http.Body PatchedWritableWirelessLANGroupRequest patchedWritableWirelessLANGroupRequest);
    ...
    Call<WirelessLANGroup> wirelessWirelessLanGroupsUpdate(
            @retrofit2.http.Path("id") Integer id,
            @retrofit2.http.Body WritableWirelessLANGroupRequest writableWirelessLANGroupRequest);
    ...
    Call<WirelessLAN> wirelessWirelessLansPartialUpdate(
            @retrofit2.http.Path("id") Integer id,
            @retrofit2.http.Body PatchedWritableWirelessLANRequest patchedWritableWirelessLANRequest);
    ...
    Call<WirelessLAN> wirelessWirelessLansUpdate(
            @retrofit2.http.Path("id") Integer id,
            @retrofit2.http.Body WritableWirelessLANRequest writableWirelessLANRequest);
    ...
    Call<WirelessLink> wirelessWirelessLinksPartialUpdate(
            @retrofit2.http.Path("id") Integer id,
            @retrofit2.http.Body PatchedWritableWirelessLinkRequest patchedWritableWirelessLinkRequest);
    ...
    Call<WirelessLink> wirelessWirelessLinksUpdate(
            @retrofit2.http.Path("id") Integer id,
            @retrofit2.http.Body WritableWirelessLinkRequest writableWirelessLinkRequest);
