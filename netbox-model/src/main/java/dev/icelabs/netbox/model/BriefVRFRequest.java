...
public class BriefVRFRequest implements Serializable {
  ...
  public static class Builder {
    ...
    private BriefVRFRequest instance;

    public Builder() {
      this(new BriefVRFRequest());
    }

    protected Builder(BriefVRFRequest instance) {
      this.instance = instance;
    }

    public BriefVRFRequest.Builder name(String name) {
      this.instance.name = name;
      return this;
    }
    public BriefVRFRequest.Builder rd(String rd) {
      this.instance.rd = rd;
      return this;
    }
    public BriefVRFRequest.Builder description(String description) {
    ...
    /**
    * returns a built BriefVRFRequest instance.
    *
    * The builder is not reusable.
    */
    public BriefVRFRequest build() {
      try {
  ...
  */
  public static BriefVRFRequest.Builder builder() {
    return new BriefVRFRequest.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public BriefVRFRequest.Builder toBuilder() {
    return new BriefVRFRequest.Builder()
      .name(getName())
      .rd(getRd())
