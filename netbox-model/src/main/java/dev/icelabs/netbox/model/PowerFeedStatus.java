...
public class PowerFeedStatus implements Serializable {
  ...
  public static class Builder {
    ...
    private PowerFeedStatus instance;

    public Builder() {
      this(new PowerFeedStatus());
    }

    protected Builder(PowerFeedStatus instance) {
      this.instance = instance;
    }

    public PowerFeedStatus.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public PowerFeedStatus.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built PowerFeedStatus instance.
    *
    * The builder is not reusable.
    */
    public PowerFeedStatus build() {
      try {
  ...
  */
  public static PowerFeedStatus.Builder builder() {
    return new PowerFeedStatus.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public PowerFeedStatus.Builder toBuilder() {
    return new PowerFeedStatus.Builder()
      .value(getValue())
      .label(getLabel());
  }
