...
public class IKEProposalAuthenticationMethod implements Serializable {
  ...
  public enum LabelEnum {
    PRE_SHARED_KEYS(String.valueOf("Pre-shared keys")),
  ...
  public IKEProposalAuthenticationMethod() {
  }

  public IKEProposalAuthenticationMethod value(@javax.annotation.Nullable ValueEnum value) {
  ...
  public IKEProposalAuthenticationMethod label(@javax.annotation.Nullable LabelEnum label) {
  ...
  public boolean equals(Object o) {
    ...
    IKEProposalAuthenticationMethod ikEProposalAuthenticationMethod = (IKEProposalAuthenticationMethod) o;
    return Objects.equals(this.value, ikEProposalAuthenticationMethod.value) &&
        Objects.equals(this.label, ikEProposalAuthenticationMethod.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class IKEProposalAuthenticationMethod {\n");
  ...
  public static class Builder {
    ...
    private IKEProposalAuthenticationMethod instance;

    public Builder() {
      this(new IKEProposalAuthenticationMethod());
    }

    protected Builder(IKEProposalAuthenticationMethod instance) {
      this.instance = instance;
    }

    public IKEProposalAuthenticationMethod.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public IKEProposalAuthenticationMethod.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built IKEProposalAuthenticationMethod instance.
    *
    * The builder is not reusable.
    */
    public IKEProposalAuthenticationMethod build() {
      try {
  ...
  */
  public static IKEProposalAuthenticationMethod.Builder builder() {
    return new IKEProposalAuthenticationMethod.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public IKEProposalAuthenticationMethod.Builder toBuilder() {
    return new IKEProposalAuthenticationMethod.Builder()
      .value(getValue())
      .label(getLabel());
  }
