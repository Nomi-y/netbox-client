...
public class WirelessLANStatus implements Serializable {
  ...
  public WirelessLANStatus value(@javax.annotation.Nullable ValueEnum value) {
  ...
  public WirelessLANStatus label(@javax.annotation.Nullable LabelEnum label) {
  ...
  public boolean equals(Object o) {
    ...
    WirelessLANStatus wirelessLANStatus = (WirelessLANStatus) o;
    return Objects.equals(this.value, wirelessLANStatus.value) &&
        Objects.equals(this.label, wirelessLANStatus.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class WirelessLANStatus {\n");
  ...
  public static class Builder {
    ...
    private WirelessLANStatus instance;

    public Builder() {
      this(new WirelessLANStatus());
    }

    protected Builder(WirelessLANStatus instance) {
      this.instance = instance;
    }

    public WirelessLANStatus.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public WirelessLANStatus.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built WirelessLANStatus instance.
    *
    * The builder is not reusable.
    */
    public WirelessLANStatus build() {
      try {
  ...
  */
  public static WirelessLANStatus.Builder builder() {
    return new WirelessLANStatus.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public WirelessLANStatus.Builder toBuilder() {
    return new WirelessLANStatus.Builder()
      .value(getValue())
      .label(getLabel());
  }
