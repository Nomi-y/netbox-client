...
public class VirtualDeviceContextStatus implements Serializable {
  ...
  public VirtualDeviceContextStatus() {
  }

  public VirtualDeviceContextStatus value(@javax.annotation.Nullable ValueEnum value) {
  ...
  public VirtualDeviceContextStatus label(@javax.annotation.Nullable LabelEnum label) {
  ...
  public boolean equals(Object o) {
    ...
    VirtualDeviceContextStatus virtualDeviceContextStatus = (VirtualDeviceContextStatus) o;
    return Objects.equals(this.value, virtualDeviceContextStatus.value) &&
        Objects.equals(this.label, virtualDeviceContextStatus.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class VirtualDeviceContextStatus {\n");
  ...
  public static class Builder {
    ...
    private VirtualDeviceContextStatus instance;

    public Builder() {
      this(new VirtualDeviceContextStatus());
    }

    protected Builder(VirtualDeviceContextStatus instance) {
      this.instance = instance;
    }

    public VirtualDeviceContextStatus.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public VirtualDeviceContextStatus.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built VirtualDeviceContextStatus instance.
    *
    * The builder is not reusable.
    */
    public VirtualDeviceContextStatus build() {
      try {
  ...
  */
  public static VirtualDeviceContextStatus.Builder builder() {
    return new VirtualDeviceContextStatus.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public VirtualDeviceContextStatus.Builder toBuilder() {
    return new VirtualDeviceContextStatus.Builder()
      .value(getValue())
      .label(getLabel());
  }
