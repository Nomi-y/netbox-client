...
> Map&lt;String, Object&gt; authenticationCheckRetrieve()
...
public class Example {
    public static void main(String[] args) {
        ...
        AuthenticationCheckApi apiInstance = new AuthenticationCheckApi(defaultClient);
        try {
            Map<String, Object> result = apiInstance.authenticationCheckRetrieve();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling AuthenticationCheckApi#authenticationCheckRetrieve");
