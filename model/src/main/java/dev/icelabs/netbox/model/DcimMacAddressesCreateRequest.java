...
public class DcimMacAddressesCreateRequest implements Serializable {
  ...
  public DcimMacAddressesCreateRequest() {
  }

  public DcimMacAddressesCreateRequest macAddress(@javax.annotation.Nonnull String macAddress) {
  ...
  public DcimMacAddressesCreateRequest tags(@javax.annotation.Nullable List<NestedTagRequest> tags) {
    
    this.tags = tags;
    return this;
  }

  public DcimMacAddressesCreateRequest addTagsItem(NestedTagRequest tagsItem) {
    if (this.tags == null) {
  ...
  public DcimMacAddressesCreateRequest customFields(@javax.annotation.Nullable Map<String, Object> customFields) {
    
    this.customFields = customFields;
    return this;
  }

  public DcimMacAddressesCreateRequest putCustomFieldsItem(String key, Object customFieldsItem) {
  ...
  public String toString() {
    ...
    sb.append("class DcimMacAddressesCreateRequest {\n");
  ...
  public static class Builder {
    ...
    private DcimMacAddressesCreateRequest instance;

    public Builder() {
      this(new DcimMacAddressesCreateRequest());
    }

    protected Builder(DcimMacAddressesCreateRequest instance) {
      this.instance = instance;
    }

    public DcimMacAddressesCreateRequest.Builder macAddress(String macAddress) {
      this.instance.macAddress = macAddress;
      return this;
    }
    public DcimMacAddressesCreateRequest.Builder assignedObjectType(String assignedObjectType) {
      this.instance.assignedObjectType = assignedObjectType;
      return this;
    }
    public DcimMacAddressesCreateRequest.Builder assignedObjectId(Long assignedObjectId) {
      this.instance.assignedObjectId = assignedObjectId;
      return this;
    }
    public DcimMacAddressesCreateRequest.Builder description(String description) {
      this.instance.description = description;
      return this;
    }
    public DcimMacAddressesCreateRequest.Builder owner(ASNRangeRequestOwner owner) {
      this.instance.owner = owner;
      return this;
    }
    public DcimMacAddressesCreateRequest.Builder comments(String comments) {
      this.instance.comments = comments;
      return this;
    }
    public DcimMacAddressesCreateRequest.Builder tags(List<NestedTagRequest> tags) {
      this.instance.tags = tags;
      return this;
    }
    public DcimMacAddressesCreateRequest.Builder customFields(Map<String, Object> customFields) {
    ...
    /**
    * returns a built DcimMacAddressesCreateRequest instance.
    *
    * The builder is not reusable.
    */
    public DcimMacAddressesCreateRequest build() {
      try {
  ...
  */
  public static DcimMacAddressesCreateRequest.Builder builder() {
    return new DcimMacAddressesCreateRequest.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public DcimMacAddressesCreateRequest.Builder toBuilder() {
    return new DcimMacAddressesCreateRequest.Builder()
