...
public class WirelessLANAuthCipher implements Serializable {
  ...
  public static class Builder {
    ...
    private WirelessLANAuthCipher instance;

    public Builder() {
      this(new WirelessLANAuthCipher());
    }

    protected Builder(WirelessLANAuthCipher instance) {
      this.instance = instance;
    }

    public WirelessLANAuthCipher.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public WirelessLANAuthCipher.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built WirelessLANAuthCipher instance.
    *
    * The builder is not reusable.
    */
    public WirelessLANAuthCipher build() {
      try {
  ...
  */
  public static WirelessLANAuthCipher.Builder builder() {
    return new WirelessLANAuthCipher.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public WirelessLANAuthCipher.Builder toBuilder() {
    return new WirelessLANAuthCipher.Builder()
      .value(getValue())
      .label(getLabel());
  }
