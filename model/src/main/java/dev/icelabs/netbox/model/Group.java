...
public class Group implements Serializable {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getUserCount() != null) {
      try {
        joiner.add(String.format(java.util.Locale.ROOT, "%suser_count%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUserCount()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
  ...
  public static class Builder {
    ...
    public Group.Builder url(URI url) {
      this.instance.url = url;
      return this;
    }
    public Group.Builder displayUrl(URI displayUrl) {
      this.instance.displayUrl = displayUrl;
      return this;
    }
    public Group.Builder display(String display) {
    ...
    public Group.Builder permissions(List<ObjectPermission> permissions) {
      this.instance.permissions = permissions;
      return this;
    }
    public Group.Builder userCount(Integer userCount) {
      this.instance.userCount = userCount;
      return this;
    }
