...
public class AggregateFamily implements Serializable {
  ...
  public AggregateFamily() {
  }

  public AggregateFamily value(@javax.annotation.Nullable ValueEnum value) {
  ...
  public AggregateFamily label(@javax.annotation.Nullable LabelEnum label) {
  ...
  public boolean equals(Object o) {
    ...
    AggregateFamily aggregateFamily = (AggregateFamily) o;
    return Objects.equals(this.value, aggregateFamily.value) &&
        Objects.equals(this.label, aggregateFamily.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class AggregateFamily {\n");
  ...
  public static class Builder {
    ...
    private AggregateFamily instance;

    public Builder() {
      this(new AggregateFamily());
    }

    protected Builder(AggregateFamily instance) {
      this.instance = instance;
    }

    public AggregateFamily.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public AggregateFamily.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built AggregateFamily instance.
    *
    * The builder is not reusable.
    */
    public AggregateFamily build() {
      try {
  ...
  */
  public static AggregateFamily.Builder builder() {
    return new AggregateFamily.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public AggregateFamily.Builder toBuilder() {
    return new AggregateFamily.Builder()
      .value(getValue())
      .label(getLabel());
  }
