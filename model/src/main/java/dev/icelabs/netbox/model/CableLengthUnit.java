...
public class CableLengthUnit implements Serializable {
  ...
  public String toString() {
    ...
    sb.append("class CableLengthUnit {\n");
  ...
  public static class Builder {
    ...
    private CableLengthUnit instance;

    public Builder() {
      this(new CableLengthUnit());
    }

    protected Builder(CableLengthUnit instance) {
      this.instance = instance;
    }

    public CableLengthUnit.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public CableLengthUnit.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built CableLengthUnit instance.
    *
    * The builder is not reusable.
    */
    public CableLengthUnit build() {
      try {
  ...
  */
  public static CableLengthUnit.Builder builder() {
    return new CableLengthUnit.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public CableLengthUnit.Builder toBuilder() {
    return new CableLengthUnit.Builder()
      .value(getValue())
      .label(getLabel());
  }
