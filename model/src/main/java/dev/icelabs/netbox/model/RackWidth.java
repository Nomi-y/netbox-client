...
public class RackWidth implements Serializable {
  ...
  public enum LabelEnum {
    _10_INCHES(String.valueOf("10 inches")),
    
    _19_INCHES(String.valueOf("19 inches")),
    
    _21_INCHES(String.valueOf("21 inches")),
    
    _23_INCHES(String.valueOf("23 inches"));
  ...
  public RackWidth value(@javax.annotation.Nullable ValueEnum value) {
  ...
  public RackWidth label(@javax.annotation.Nullable LabelEnum label) {
  ...
  public boolean equals(Object o) {
    ...
    RackWidth rackWidth = (RackWidth) o;
    return Objects.equals(this.value, rackWidth.value) &&
        Objects.equals(this.label, rackWidth.label);
  }
  ...
  public static class Builder {
    ...
    private RackWidth instance;

    public Builder() {
      this(new RackWidth());
    }

    protected Builder(RackWidth instance) {
      this.instance = instance;
    }

    public RackWidth.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public RackWidth.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built RackWidth instance.
    *
    * The builder is not reusable.
    */
    public RackWidth build() {
      try {
  ...
  */
  public static RackWidth.Builder builder() {
    return new RackWidth.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public RackWidth.Builder toBuilder() {
    return new RackWidth.Builder()
      .value(getValue())
      .label(getLabel());
  }
