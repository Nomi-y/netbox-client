...
public class BriefJobStatus implements Serializable {
  ...
  public enum ValueEnum {
    ...
    ERRORED(String.valueOf("errored")),
  ...
  public BriefJobStatus() {
  }

  public BriefJobStatus value(@javax.annotation.Nullable ValueEnum value) {
  ...
  public BriefJobStatus label(@javax.annotation.Nullable LabelEnum label) {
  ...
  public boolean equals(Object o) {
    ...
    BriefJobStatus briefJobStatus = (BriefJobStatus) o;
    return Objects.equals(this.value, briefJobStatus.value) &&
        Objects.equals(this.label, briefJobStatus.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class BriefJobStatus {\n");
  ...
  public static class Builder {
    ...
    private BriefJobStatus instance;

    public Builder() {
      this(new BriefJobStatus());
    }

    protected Builder(BriefJobStatus instance) {
      this.instance = instance;
    }

    public BriefJobStatus.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public BriefJobStatus.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built BriefJobStatus instance.
    *
    * The builder is not reusable.
    */
    public BriefJobStatus build() {
      try {
  ...
  */
  public static BriefJobStatus.Builder builder() {
    return new BriefJobStatus.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public BriefJobStatus.Builder toBuilder() {
    return new BriefJobStatus.Builder()
      .value(getValue())
      .label(getLabel());
  }
