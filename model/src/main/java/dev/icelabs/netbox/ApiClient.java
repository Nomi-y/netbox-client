...
import dev.icelabs.netbox.auth.HttpBasicAuth;
...
public class ApiClient {
    ...
    public void createAdapter(String baseUrl) {
        json = new JSON();
...
class GsonResponseBodyConverterToString<T> implements Converter<ResponseBody, T> {
    ...
    public T convert(ResponseBody value) throws IOException {
        ...
        try {
            ...
            return (T) returned;
            // INFO: Supressing unchecked cast warning
            // because the code is autogenerated
        }
    }
}
