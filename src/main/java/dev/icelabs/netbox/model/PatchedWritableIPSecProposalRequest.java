 ...
 */
@JsonPropertyOrder({
  PatchedWritableIPSecProposalRequest.JSON_PROPERTY_NAME,
  PatchedWritableIPSecProposalRequest.JSON_PROPERTY_DESCRIPTION,
  PatchedWritableIPSecProposalRequest.JSON_PROPERTY_ENCRYPTION_ALGORITHM,
  PatchedWritableIPSecProposalRequest.JSON_PROPERTY_AUTHENTICATION_ALGORITHM,
  PatchedWritableIPSecProposalRequest.JSON_PROPERTY_SA_LIFETIME_SECONDS,
  PatchedWritableIPSecProposalRequest.JSON_PROPERTY_SA_LIFETIME_DATA,
  PatchedWritableIPSecProposalRequest.JSON_PROPERTY_OWNER,
  PatchedWritableIPSecProposalRequest.JSON_PROPERTY_COMMENTS,
  PatchedWritableIPSecProposalRequest.JSON_PROPERTY_TAGS,
  PatchedWritableIPSecProposalRequest.JSON_PROPERTY_CUSTOM_FIELDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class PatchedWritableIPSecProposalRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, patchedWritableIPSecProposalRequest.name) &&
        ...
        equalsNullable(this.encryptionAlgorithm, patchedWritableIPSecProposalRequest.encryptionAlgorithm) &&
        equalsNullable(this.authenticationAlgorithm, patchedWritableIPSecProposalRequest.authenticationAlgorithm) &&
        equalsNullable(this.saLifetimeSeconds, patchedWritableIPSecProposalRequest.saLifetimeSeconds) &&
        equalsNullable(this.saLifetimeData, patchedWritableIPSecProposalRequest.saLifetimeData) &&
        equalsNullable(this.owner, patchedWritableIPSecProposalRequest.owner) &&
