 ...
 */
@JsonPropertyOrder({
  PatchedWritableCircuitGroupAssignmentRequest.JSON_PROPERTY_GROUP,
  PatchedWritableCircuitGroupAssignmentRequest.JSON_PROPERTY_MEMBER_TYPE,
  PatchedWritableCircuitGroupAssignmentRequest.JSON_PROPERTY_MEMBER_ID,
...
public class PatchedWritableCircuitGroupAssignmentRequest {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_MEMBER_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_MEMBER_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
