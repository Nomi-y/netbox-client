 ...
 */
@JsonPropertyOrder({
  WritablePowerOutletTemplateRequest.JSON_PROPERTY_DEVICE_TYPE,
  WritablePowerOutletTemplateRequest.JSON_PROPERTY_MODULE_TYPE,
  WritablePowerOutletTemplateRequest.JSON_PROPERTY_NAME,
  WritablePowerOutletTemplateRequest.JSON_PROPERTY_LABEL,
  WritablePowerOutletTemplateRequest.JSON_PROPERTY_TYPE,
  WritablePowerOutletTemplateRequest.JSON_PROPERTY_COLOR,
  WritablePowerOutletTemplateRequest.JSON_PROPERTY_POWER_PORT,
  WritablePowerOutletTemplateRequest.JSON_PROPERTY_FEED_LEG,
  WritablePowerOutletTemplateRequest.JSON_PROPERTY_DESCRIPTION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class WritablePowerOutletTemplateRequest {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.deviceType, writablePowerOutletTemplateRequest.deviceType) &&
        equalsNullable(this.moduleType, writablePowerOutletTemplateRequest.moduleType) &&
        ...
        equalsNullable(this.type, writablePowerOutletTemplateRequest.type) &&
        Objects.equals(this.color, writablePowerOutletTemplateRequest.color) &&
        equalsNullable(this.powerPort, writablePowerOutletTemplateRequest.powerPort) &&
        equalsNullable(this.feedLeg, writablePowerOutletTemplateRequest.feedLeg) &&
