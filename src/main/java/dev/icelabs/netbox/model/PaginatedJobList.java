 ...
 */
@JsonPropertyOrder({
  PaginatedJobList.JSON_PROPERTY_COUNT,
  PaginatedJobList.JSON_PROPERTY_NEXT,
  PaginatedJobList.JSON_PROPERTY_PREVIOUS,
  PaginatedJobList.JSON_PROPERTY_RESULTS
})
...
public class PaginatedJobList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedJobList.count) &&
        equalsNullable(this.next, paginatedJobList.next) &&
        equalsNullable(this.previous, paginatedJobList.previous) &&
