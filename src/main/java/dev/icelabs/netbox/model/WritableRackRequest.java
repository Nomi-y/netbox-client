...
public class WritableRackRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, writableRackRequest.name) &&
        equalsNullable(this.facilityId, writableRackRequest.facilityId) &&
        Objects.equals(this.site, writableRackRequest.site) &&
        equalsNullable(this.location, writableRackRequest.location) &&
        equalsNullable(this.tenant, writableRackRequest.tenant) &&
        Objects.equals(this.status, writableRackRequest.status) &&
        equalsNullable(this.role, writableRackRequest.role) &&
        Objects.equals(this.serial, writableRackRequest.serial) &&
        equalsNullable(this.assetTag, writableRackRequest.assetTag) &&
        equalsNullable(this.rackType, writableRackRequest.rackType) &&
        equalsNullable(this.formFactor, writableRackRequest.formFactor) &&
        ...
        equalsNullable(this.weight, writableRackRequest.weight) &&
        equalsNullable(this.maxWeight, writableRackRequest.maxWeight) &&
        equalsNullable(this.weightUnit, writableRackRequest.weightUnit) &&
        Objects.equals(this.descUnits, writableRackRequest.descUnits) &&
        equalsNullable(this.outerWidth, writableRackRequest.outerWidth) &&
        equalsNullable(this.outerHeight, writableRackRequest.outerHeight) &&
        equalsNullable(this.outerDepth, writableRackRequest.outerDepth) &&
        equalsNullable(this.outerUnit, writableRackRequest.outerUnit) &&
        equalsNullable(this.mountingDepth, writableRackRequest.mountingDepth) &&
        equalsNullable(this.airflow, writableRackRequest.airflow) &&
        Objects.equals(this.description, writableRackRequest.description) &&
        equalsNullable(this.owner, writableRackRequest.owner) &&
