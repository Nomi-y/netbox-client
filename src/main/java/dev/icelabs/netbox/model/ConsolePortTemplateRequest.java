 ...
 */
@JsonPropertyOrder({
  ConsolePortTemplateRequest.JSON_PROPERTY_DEVICE_TYPE,
  ConsolePortTemplateRequest.JSON_PROPERTY_MODULE_TYPE,
  ConsolePortTemplateRequest.JSON_PROPERTY_NAME,
  ConsolePortTemplateRequest.JSON_PROPERTY_LABEL,
  ConsolePortTemplateRequest.JSON_PROPERTY_TYPE,
  ConsolePortTemplateRequest.JSON_PROPERTY_DESCRIPTION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class ConsolePortTemplateRequest {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.deviceType, consolePortTemplateRequest.deviceType) &&
        equalsNullable(this.moduleType, consolePortTemplateRequest.moduleType) &&
