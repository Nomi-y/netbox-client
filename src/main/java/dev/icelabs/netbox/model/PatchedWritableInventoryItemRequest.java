 ...
 */
@JsonPropertyOrder({
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_DEVICE,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_PARENT,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_NAME,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_LABEL,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_STATUS,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_ROLE,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_MANUFACTURER,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_PART_ID,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_SERIAL,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_ASSET_TAG,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_DISCOVERED,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_DESCRIPTION,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_COMPONENT_TYPE,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_COMPONENT_ID,
  PatchedWritableInventoryItemRequest.JSON_PROPERTY_OWNER,
