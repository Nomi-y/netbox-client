 ...
 */
@JsonPropertyOrder({
  DcimDevicesCreateRequest.JSON_PROPERTY_NAME,
  DcimDevicesCreateRequest.JSON_PROPERTY_DEVICE_TYPE,
  DcimDevicesCreateRequest.JSON_PROPERTY_ROLE,
  DcimDevicesCreateRequest.JSON_PROPERTY_TENANT,
  DcimDevicesCreateRequest.JSON_PROPERTY_PLATFORM,
  DcimDevicesCreateRequest.JSON_PROPERTY_SERIAL,
  DcimDevicesCreateRequest.JSON_PROPERTY_ASSET_TAG,
  DcimDevicesCreateRequest.JSON_PROPERTY_SITE,
  DcimDevicesCreateRequest.JSON_PROPERTY_LOCATION,
  DcimDevicesCreateRequest.JSON_PROPERTY_RACK,
  DcimDevicesCreateRequest.JSON_PROPERTY_POSITION,
  DcimDevicesCreateRequest.JSON_PROPERTY_FACE,
  DcimDevicesCreateRequest.JSON_PROPERTY_LATITUDE,
  DcimDevicesCreateRequest.JSON_PROPERTY_LONGITUDE,
  DcimDevicesCreateRequest.JSON_PROPERTY_STATUS,
  DcimDevicesCreateRequest.JSON_PROPERTY_AIRFLOW,
  DcimDevicesCreateRequest.JSON_PROPERTY_PRIMARY_IP4,
  DcimDevicesCreateRequest.JSON_PROPERTY_PRIMARY_IP6,
  DcimDevicesCreateRequest.JSON_PROPERTY_OOB_IP,
  DcimDevicesCreateRequest.JSON_PROPERTY_CLUSTER,
  DcimDevicesCreateRequest.JSON_PROPERTY_VIRTUAL_CHASSIS,
  DcimDevicesCreateRequest.JSON_PROPERTY_VC_POSITION,
  DcimDevicesCreateRequest.JSON_PROPERTY_VC_PRIORITY,
  DcimDevicesCreateRequest.JSON_PROPERTY_DESCRIPTION,
  DcimDevicesCreateRequest.JSON_PROPERTY_OWNER,
  DcimDevicesCreateRequest.JSON_PROPERTY_COMMENTS,
  DcimDevicesCreateRequest.JSON_PROPERTY_CONFIG_TEMPLATE,
  DcimDevicesCreateRequest.JSON_PROPERTY_LOCAL_CONTEXT_DATA,
  DcimDevicesCreateRequest.JSON_PROPERTY_TAGS,
