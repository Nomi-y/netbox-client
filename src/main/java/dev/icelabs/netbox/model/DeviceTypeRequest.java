 ...
 */
@JsonPropertyOrder({
  DeviceTypeRequest.JSON_PROPERTY_MANUFACTURER,
  DeviceTypeRequest.JSON_PROPERTY_DEFAULT_PLATFORM,
  DeviceTypeRequest.JSON_PROPERTY_MODEL,
  DeviceTypeRequest.JSON_PROPERTY_SLUG,
  DeviceTypeRequest.JSON_PROPERTY_PART_NUMBER,
  DeviceTypeRequest.JSON_PROPERTY_U_HEIGHT,
  DeviceTypeRequest.JSON_PROPERTY_EXCLUDE_FROM_UTILIZATION,
  DeviceTypeRequest.JSON_PROPERTY_IS_FULL_DEPTH,
  DeviceTypeRequest.JSON_PROPERTY_SUBDEVICE_ROLE,
  DeviceTypeRequest.JSON_PROPERTY_AIRFLOW,
  DeviceTypeRequest.JSON_PROPERTY_WEIGHT,
  DeviceTypeRequest.JSON_PROPERTY_WEIGHT_UNIT,
  DeviceTypeRequest.JSON_PROPERTY_FRONT_IMAGE,
  DeviceTypeRequest.JSON_PROPERTY_REAR_IMAGE,
  DeviceTypeRequest.JSON_PROPERTY_DESCRIPTION,
  DeviceTypeRequest.JSON_PROPERTY_OWNER,
  DeviceTypeRequest.JSON_PROPERTY_COMMENTS,
  DeviceTypeRequest.JSON_PROPERTY_TAGS,
  DeviceTypeRequest.JSON_PROPERTY_CUSTOM_FIELDS
})
...
public class DeviceTypeRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.manufacturer, deviceTypeRequest.manufacturer) &&
        equalsNullable(this.defaultPlatform, deviceTypeRequest.defaultPlatform) &&
        ...
        equalsNullable(this.subdeviceRole, deviceTypeRequest.subdeviceRole) &&
        equalsNullable(this.airflow, deviceTypeRequest.airflow) &&
        equalsNullable(this.weight, deviceTypeRequest.weight) &&
        equalsNullable(this.weightUnit, deviceTypeRequest.weightUnit) &&
        equalsNullable(this.frontImage, deviceTypeRequest.frontImage) &&
        equalsNullable(this.rearImage, deviceTypeRequest.rearImage) &&
        Objects.equals(this.description, deviceTypeRequest.description) &&
        equalsNullable(this.owner, deviceTypeRequest.owner) &&
