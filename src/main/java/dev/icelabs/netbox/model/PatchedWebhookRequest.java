 ...
 */
@JsonPropertyOrder({
  PatchedWebhookRequest.JSON_PROPERTY_NAME,
  PatchedWebhookRequest.JSON_PROPERTY_DESCRIPTION,
  PatchedWebhookRequest.JSON_PROPERTY_PAYLOAD_URL,
  PatchedWebhookRequest.JSON_PROPERTY_HTTP_METHOD,
  PatchedWebhookRequest.JSON_PROPERTY_HTTP_CONTENT_TYPE,
  PatchedWebhookRequest.JSON_PROPERTY_ADDITIONAL_HEADERS,
  PatchedWebhookRequest.JSON_PROPERTY_BODY_TEMPLATE,
  PatchedWebhookRequest.JSON_PROPERTY_SECRET,
  PatchedWebhookRequest.JSON_PROPERTY_SSL_VERIFICATION,
  PatchedWebhookRequest.JSON_PROPERTY_CA_FILE_PATH,
  PatchedWebhookRequest.JSON_PROPERTY_CUSTOM_FIELDS,
