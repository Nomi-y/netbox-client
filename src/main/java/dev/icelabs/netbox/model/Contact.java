...
public class Contact {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, contact.id) &&
        ...
        equalsNullable(this.owner, contact.owner) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, displayUrl, display, groups, name, title, phone, email, address, link, description, hashCodeNullable(owner), comments, tags, customFields, created, lastUpdated);
  }
