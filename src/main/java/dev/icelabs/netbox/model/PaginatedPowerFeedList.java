 ...
 */
@JsonPropertyOrder({
  PaginatedPowerFeedList.JSON_PROPERTY_COUNT,
  PaginatedPowerFeedList.JSON_PROPERTY_NEXT,
  PaginatedPowerFeedList.JSON_PROPERTY_PREVIOUS,
  PaginatedPowerFeedList.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class PaginatedPowerFeedList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedPowerFeedList.count) &&
        equalsNullable(this.next, paginatedPowerFeedList.next) &&
        equalsNullable(this.previous, paginatedPowerFeedList.previous) &&
