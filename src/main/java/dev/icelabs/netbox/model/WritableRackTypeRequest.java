 ...
 */
@JsonPropertyOrder({
  WritableRackTypeRequest.JSON_PROPERTY_MANUFACTURER,
  WritableRackTypeRequest.JSON_PROPERTY_MODEL,
  WritableRackTypeRequest.JSON_PROPERTY_SLUG,
  WritableRackTypeRequest.JSON_PROPERTY_DESCRIPTION,
  WritableRackTypeRequest.JSON_PROPERTY_FORM_FACTOR,
  WritableRackTypeRequest.JSON_PROPERTY_WIDTH,
  WritableRackTypeRequest.JSON_PROPERTY_U_HEIGHT,
  WritableRackTypeRequest.JSON_PROPERTY_STARTING_UNIT,
  WritableRackTypeRequest.JSON_PROPERTY_DESC_UNITS,
  WritableRackTypeRequest.JSON_PROPERTY_OUTER_WIDTH,
  WritableRackTypeRequest.JSON_PROPERTY_OUTER_HEIGHT,
  WritableRackTypeRequest.JSON_PROPERTY_OUTER_DEPTH,
  WritableRackTypeRequest.JSON_PROPERTY_OUTER_UNIT,
  WritableRackTypeRequest.JSON_PROPERTY_WEIGHT,
  WritableRackTypeRequest.JSON_PROPERTY_MAX_WEIGHT,
  WritableRackTypeRequest.JSON_PROPERTY_WEIGHT_UNIT,
  WritableRackTypeRequest.JSON_PROPERTY_MOUNTING_DEPTH,
  WritableRackTypeRequest.JSON_PROPERTY_OWNER,
  WritableRackTypeRequest.JSON_PROPERTY_COMMENTS,
  WritableRackTypeRequest.JSON_PROPERTY_TAGS,
  WritableRackTypeRequest.JSON_PROPERTY_CUSTOM_FIELDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class WritableRackTypeRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.manufacturer, writableRackTypeRequest.manufacturer) &&
        ...
        equalsNullable(this.outerWidth, writableRackTypeRequest.outerWidth) &&
        equalsNullable(this.outerHeight, writableRackTypeRequest.outerHeight) &&
        equalsNullable(this.outerDepth, writableRackTypeRequest.outerDepth) &&
        equalsNullable(this.outerUnit, writableRackTypeRequest.outerUnit) &&
        equalsNullable(this.weight, writableRackTypeRequest.weight) &&
        equalsNullable(this.maxWeight, writableRackTypeRequest.maxWeight) &&
        equalsNullable(this.weightUnit, writableRackTypeRequest.weightUnit) &&
        equalsNullable(this.mountingDepth, writableRackTypeRequest.mountingDepth) &&
        equalsNullable(this.owner, writableRackTypeRequest.owner) &&
