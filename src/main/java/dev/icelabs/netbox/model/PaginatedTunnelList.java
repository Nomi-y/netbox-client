 ...
 */
@JsonPropertyOrder({
  PaginatedTunnelList.JSON_PROPERTY_COUNT,
  PaginatedTunnelList.JSON_PROPERTY_NEXT,
  PaginatedTunnelList.JSON_PROPERTY_PREVIOUS,
  PaginatedTunnelList.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class PaginatedTunnelList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedTunnelList.count) &&
        equalsNullable(this.next, paginatedTunnelList.next) &&
        equalsNullable(this.previous, paginatedTunnelList.previous) &&
