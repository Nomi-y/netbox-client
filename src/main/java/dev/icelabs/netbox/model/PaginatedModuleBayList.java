 ...
 */
@JsonPropertyOrder({
  PaginatedModuleBayList.JSON_PROPERTY_COUNT,
  PaginatedModuleBayList.JSON_PROPERTY_NEXT,
  PaginatedModuleBayList.JSON_PROPERTY_PREVIOUS,
  PaginatedModuleBayList.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class PaginatedModuleBayList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedModuleBayList.count) &&
        equalsNullable(this.next, paginatedModuleBayList.next) &&
        equalsNullable(this.previous, paginatedModuleBayList.previous) &&
