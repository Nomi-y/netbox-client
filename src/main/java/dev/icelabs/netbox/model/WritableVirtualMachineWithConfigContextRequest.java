...
public class WritableVirtualMachineWithConfigContextRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, writableVirtualMachineWithConfigContextRequest.name) &&
        ...
        equalsNullable(this.site, writableVirtualMachineWithConfigContextRequest.site) &&
        equalsNullable(this.cluster, writableVirtualMachineWithConfigContextRequest.cluster) &&
        equalsNullable(this.device, writableVirtualMachineWithConfigContextRequest.device) &&
        Objects.equals(this.serial, writableVirtualMachineWithConfigContextRequest.serial) &&
        equalsNullable(this.role, writableVirtualMachineWithConfigContextRequest.role) &&
        equalsNullable(this.tenant, writableVirtualMachineWithConfigContextRequest.tenant) &&
        equalsNullable(this.platform, writableVirtualMachineWithConfigContextRequest.platform) &&
        equalsNullable(this.primaryIp4, writableVirtualMachineWithConfigContextRequest.primaryIp4) &&
        equalsNullable(this.primaryIp6, writableVirtualMachineWithConfigContextRequest.primaryIp6) &&
        equalsNullable(this.vcpus, writableVirtualMachineWithConfigContextRequest.vcpus) &&
        equalsNullable(this.memory, writableVirtualMachineWithConfigContextRequest.memory) &&
        equalsNullable(this.disk, writableVirtualMachineWithConfigContextRequest.disk) &&
        Objects.equals(this.description, writableVirtualMachineWithConfigContextRequest.description) &&
        equalsNullable(this.owner, writableVirtualMachineWithConfigContextRequest.owner) &&
        Objects.equals(this.comments, writableVirtualMachineWithConfigContextRequest.comments) &&
        equalsNullable(this.configTemplate, writableVirtualMachineWithConfigContextRequest.configTemplate) &&
        equalsNullable(this.localContextData, writableVirtualMachineWithConfigContextRequest.localContextData) &&
