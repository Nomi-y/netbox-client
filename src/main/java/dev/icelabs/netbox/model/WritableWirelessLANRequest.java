...
public class WritableWirelessLANRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ssid, writableWirelessLANRequest.ssid) &&
        ...
        equalsNullable(this.group, writableWirelessLANRequest.group) &&
        Objects.equals(this.status, writableWirelessLANRequest.status) &&
        equalsNullable(this.vlan, writableWirelessLANRequest.vlan) &&
        equalsNullable(this.scopeType, writableWirelessLANRequest.scopeType) &&
        equalsNullable(this.scopeId, writableWirelessLANRequest.scopeId) &&
        equalsNullable(this.tenant, writableWirelessLANRequest.tenant) &&
        equalsNullable(this.authType, writableWirelessLANRequest.authType) &&
        equalsNullable(this.authCipher, writableWirelessLANRequest.authCipher) &&
        Objects.equals(this.authPsk, writableWirelessLANRequest.authPsk) &&
        equalsNullable(this.owner, writableWirelessLANRequest.owner) &&
