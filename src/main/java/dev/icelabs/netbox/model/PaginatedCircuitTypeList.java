 ...
 */
@JsonPropertyOrder({
  PaginatedCircuitTypeList.JSON_PROPERTY_COUNT,
  PaginatedCircuitTypeList.JSON_PROPERTY_NEXT,
  PaginatedCircuitTypeList.JSON_PROPERTY_PREVIOUS,
  PaginatedCircuitTypeList.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class PaginatedCircuitTypeList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedCircuitTypeList.count) &&
        equalsNullable(this.next, paginatedCircuitTypeList.next) &&
        equalsNullable(this.previous, paginatedCircuitTypeList.previous) &&
