 ...
 */
@JsonPropertyOrder({
  DashboardRequest.JSON_PROPERTY_LAYOUT,
  DashboardRequest.JSON_PROPERTY_CONFIG
})
...
public class DashboardRequest {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.layout, dashboardRequest.layout) &&
        equalsNullable(this.config, dashboardRequest.config);
  }
