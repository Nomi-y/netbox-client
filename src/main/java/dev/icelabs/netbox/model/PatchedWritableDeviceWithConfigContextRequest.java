...
public class PatchedWritableDeviceWithConfigContextRequest {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, patchedWritableDeviceWithConfigContextRequest.name) &&
        ...
        equalsNullable(this.tenant, patchedWritableDeviceWithConfigContextRequest.tenant) &&
        equalsNullable(this.platform, patchedWritableDeviceWithConfigContextRequest.platform) &&
        Objects.equals(this.serial, patchedWritableDeviceWithConfigContextRequest.serial) &&
        equalsNullable(this.assetTag, patchedWritableDeviceWithConfigContextRequest.assetTag) &&
        Objects.equals(this.site, patchedWritableDeviceWithConfigContextRequest.site) &&
        equalsNullable(this.location, patchedWritableDeviceWithConfigContextRequest.location) &&
        equalsNullable(this.rack, patchedWritableDeviceWithConfigContextRequest.rack) &&
        equalsNullable(this.position, patchedWritableDeviceWithConfigContextRequest.position) &&
        equalsNullable(this.face, patchedWritableDeviceWithConfigContextRequest.face) &&
        equalsNullable(this.latitude, patchedWritableDeviceWithConfigContextRequest.latitude) &&
        equalsNullable(this.longitude, patchedWritableDeviceWithConfigContextRequest.longitude) &&
        Objects.equals(this.status, patchedWritableDeviceWithConfigContextRequest.status) &&
        equalsNullable(this.airflow, patchedWritableDeviceWithConfigContextRequest.airflow) &&
        equalsNullable(this.primaryIp4, patchedWritableDeviceWithConfigContextRequest.primaryIp4) &&
        equalsNullable(this.primaryIp6, patchedWritableDeviceWithConfigContextRequest.primaryIp6) &&
        equalsNullable(this.oobIp, patchedWritableDeviceWithConfigContextRequest.oobIp) &&
        equalsNullable(this.cluster, patchedWritableDeviceWithConfigContextRequest.cluster) &&
        equalsNullable(this.virtualChassis, patchedWritableDeviceWithConfigContextRequest.virtualChassis) &&
        equalsNullable(this.vcPosition, patchedWritableDeviceWithConfigContextRequest.vcPosition) &&
        equalsNullable(this.vcPriority, patchedWritableDeviceWithConfigContextRequest.vcPriority) &&
        Objects.equals(this.description, patchedWritableDeviceWithConfigContextRequest.description) &&
        equalsNullable(this.owner, patchedWritableDeviceWithConfigContextRequest.owner) &&
        Objects.equals(this.comments, patchedWritableDeviceWithConfigContextRequest.comments) &&
        equalsNullable(this.configTemplate, patchedWritableDeviceWithConfigContextRequest.configTemplate) &&
        equalsNullable(this.localContextData, patchedWritableDeviceWithConfigContextRequest.localContextData) &&
