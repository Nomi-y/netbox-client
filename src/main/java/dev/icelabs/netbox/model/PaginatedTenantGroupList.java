 ...
 */
@JsonPropertyOrder({
  PaginatedTenantGroupList.JSON_PROPERTY_COUNT,
  PaginatedTenantGroupList.JSON_PROPERTY_NEXT,
  PaginatedTenantGroupList.JSON_PROPERTY_PREVIOUS,
  PaginatedTenantGroupList.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class PaginatedTenantGroupList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedTenantGroupList.count) &&
        equalsNullable(this.next, paginatedTenantGroupList.next) &&
        equalsNullable(this.previous, paginatedTenantGroupList.previous) &&
