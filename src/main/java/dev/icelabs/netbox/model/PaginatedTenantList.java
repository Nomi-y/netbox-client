 ...
 */
@JsonPropertyOrder({
  PaginatedTenantList.JSON_PROPERTY_COUNT,
  PaginatedTenantList.JSON_PROPERTY_NEXT,
  PaginatedTenantList.JSON_PROPERTY_PREVIOUS,
  PaginatedTenantList.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class PaginatedTenantList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedTenantList.count) &&
        equalsNullable(this.next, paginatedTenantList.next) &&
        equalsNullable(this.previous, paginatedTenantList.previous) &&
