 ...
 */
@JsonPropertyOrder({
  PaginatedAggregateList.JSON_PROPERTY_COUNT,
  PaginatedAggregateList.JSON_PROPERTY_NEXT,
  PaginatedAggregateList.JSON_PROPERTY_PREVIOUS,
  PaginatedAggregateList.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class PaginatedAggregateList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedAggregateList.count) &&
        equalsNullable(this.next, paginatedAggregateList.next) &&
        equalsNullable(this.previous, paginatedAggregateList.previous) &&
