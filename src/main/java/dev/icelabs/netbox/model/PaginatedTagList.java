 ...
 */
@JsonPropertyOrder({
  PaginatedTagList.JSON_PROPERTY_COUNT,
  PaginatedTagList.JSON_PROPERTY_NEXT,
  PaginatedTagList.JSON_PROPERTY_PREVIOUS,
  PaginatedTagList.JSON_PROPERTY_RESULTS
})
...
public class PaginatedTagList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedTagList.count) &&
        equalsNullable(this.next, paginatedTagList.next) &&
        equalsNullable(this.previous, paginatedTagList.previous) &&
