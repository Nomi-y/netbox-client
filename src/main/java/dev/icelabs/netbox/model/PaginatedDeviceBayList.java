 ...
 */
@JsonPropertyOrder({
  PaginatedDeviceBayList.JSON_PROPERTY_COUNT,
  PaginatedDeviceBayList.JSON_PROPERTY_NEXT,
  PaginatedDeviceBayList.JSON_PROPERTY_PREVIOUS,
  PaginatedDeviceBayList.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class PaginatedDeviceBayList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedDeviceBayList.count) &&
        equalsNullable(this.next, paginatedDeviceBayList.next) &&
        equalsNullable(this.previous, paginatedDeviceBayList.previous) &&
