 ...
 */
@JsonPropertyOrder({
  PaginatedRIRList.JSON_PROPERTY_COUNT,
  PaginatedRIRList.JSON_PROPERTY_NEXT,
  PaginatedRIRList.JSON_PROPERTY_PREVIOUS,
  PaginatedRIRList.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class PaginatedRIRList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedRIRList.count) &&
        equalsNullable(this.next, paginatedRIRList.next) &&
        equalsNullable(this.previous, paginatedRIRList.previous) &&
