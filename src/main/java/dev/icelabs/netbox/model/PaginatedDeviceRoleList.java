 ...
 */
@JsonPropertyOrder({
  PaginatedDeviceRoleList.JSON_PROPERTY_COUNT,
  PaginatedDeviceRoleList.JSON_PROPERTY_NEXT,
  PaginatedDeviceRoleList.JSON_PROPERTY_PREVIOUS,
  PaginatedDeviceRoleList.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class PaginatedDeviceRoleList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedDeviceRoleList.count) &&
        equalsNullable(this.next, paginatedDeviceRoleList.next) &&
        equalsNullable(this.previous, paginatedDeviceRoleList.previous) &&
