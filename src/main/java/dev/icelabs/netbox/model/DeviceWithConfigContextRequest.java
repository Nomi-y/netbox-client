...
public class DeviceWithConfigContextRequest {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, deviceWithConfigContextRequest.name) &&
        ...
        equalsNullable(this.tenant, deviceWithConfigContextRequest.tenant) &&
        equalsNullable(this.platform, deviceWithConfigContextRequest.platform) &&
        Objects.equals(this.serial, deviceWithConfigContextRequest.serial) &&
        equalsNullable(this.assetTag, deviceWithConfigContextRequest.assetTag) &&
        Objects.equals(this.site, deviceWithConfigContextRequest.site) &&
        equalsNullable(this.location, deviceWithConfigContextRequest.location) &&
        equalsNullable(this.rack, deviceWithConfigContextRequest.rack) &&
        equalsNullable(this.position, deviceWithConfigContextRequest.position) &&
        Objects.equals(this.face, deviceWithConfigContextRequest.face) &&
        equalsNullable(this.latitude, deviceWithConfigContextRequest.latitude) &&
        equalsNullable(this.longitude, deviceWithConfigContextRequest.longitude) &&
        ...
        equalsNullable(this.primaryIp4, deviceWithConfigContextRequest.primaryIp4) &&
        equalsNullable(this.primaryIp6, deviceWithConfigContextRequest.primaryIp6) &&
        equalsNullable(this.oobIp, deviceWithConfigContextRequest.oobIp) &&
        equalsNullable(this.cluster, deviceWithConfigContextRequest.cluster) &&
        equalsNullable(this.virtualChassis, deviceWithConfigContextRequest.virtualChassis) &&
        equalsNullable(this.vcPosition, deviceWithConfigContextRequest.vcPosition) &&
        equalsNullable(this.vcPriority, deviceWithConfigContextRequest.vcPriority) &&
        Objects.equals(this.description, deviceWithConfigContextRequest.description) &&
        equalsNullable(this.owner, deviceWithConfigContextRequest.owner) &&
        Objects.equals(this.comments, deviceWithConfigContextRequest.comments) &&
        equalsNullable(this.configTemplate, deviceWithConfigContextRequest.configTemplate) &&
        equalsNullable(this.localContextData, deviceWithConfigContextRequest.localContextData) &&
