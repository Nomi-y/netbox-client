 ...
 */
@JsonPropertyOrder({
  PowerOutletFeedLeg.JSON_PROPERTY_VALUE,
  PowerOutletFeedLeg.JSON_PROPERTY_LABEL
})
@JsonTypeName("PowerOutlet_feed_leg")
...
public class PowerOutletFeedLeg {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.value, powerOutletFeedLeg.value) &&
