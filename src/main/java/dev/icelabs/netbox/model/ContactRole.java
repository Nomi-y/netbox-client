...
@JsonPropertyOrder({
  ...
  ContactRole.JSON_PROPERTY_DISPLAY_URL,
  ...
  ContactRole.JSON_PROPERTY_OWNER,
  ContactRole.JSON_PROPERTY_COMMENTS,
...
public class ContactRole {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, contactRole.id) &&
        ...
        equalsNullable(this.owner, contactRole.owner) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, displayUrl, display, name, slug, description, hashCodeNullable(owner), comments, tags, customFields, created, lastUpdated);
  }
