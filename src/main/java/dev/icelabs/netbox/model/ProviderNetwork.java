...
public class ProviderNetwork {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, providerNetwork.id) &&
        ...
        equalsNullable(this.owner, providerNetwork.owner) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, displayUrl, display, provider, name, serviceId, description, hashCodeNullable(owner), comments, tags, customFields, created, lastUpdated);
  }
