 ...
 */
@JsonPropertyOrder({
  PaginatedClusterTypeList.JSON_PROPERTY_COUNT,
  PaginatedClusterTypeList.JSON_PROPERTY_NEXT,
  PaginatedClusterTypeList.JSON_PROPERTY_PREVIOUS,
  PaginatedClusterTypeList.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class PaginatedClusterTypeList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedClusterTypeList.count) &&
        equalsNullable(this.next, paginatedClusterTypeList.next) &&
        equalsNullable(this.previous, paginatedClusterTypeList.previous) &&
