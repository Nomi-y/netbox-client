 ...
 */
@JsonPropertyOrder({
  WritableConsolePortTemplateRequest.JSON_PROPERTY_DEVICE_TYPE,
  WritableConsolePortTemplateRequest.JSON_PROPERTY_MODULE_TYPE,
  WritableConsolePortTemplateRequest.JSON_PROPERTY_NAME,
  WritableConsolePortTemplateRequest.JSON_PROPERTY_LABEL,
  WritableConsolePortTemplateRequest.JSON_PROPERTY_TYPE,
  WritableConsolePortTemplateRequest.JSON_PROPERTY_DESCRIPTION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class WritableConsolePortTemplateRequest {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.deviceType, writableConsolePortTemplateRequest.deviceType) &&
        equalsNullable(this.moduleType, writableConsolePortTemplateRequest.moduleType) &&
        ...
        equalsNullable(this.type, writableConsolePortTemplateRequest.type) &&
