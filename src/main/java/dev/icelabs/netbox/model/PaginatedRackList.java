 ...
 */
@JsonPropertyOrder({
  PaginatedRackList.JSON_PROPERTY_COUNT,
  PaginatedRackList.JSON_PROPERTY_NEXT,
  PaginatedRackList.JSON_PROPERTY_PREVIOUS,
  PaginatedRackList.JSON_PROPERTY_RESULTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-14T09:38:16.451149892Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
public class PaginatedRackList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedRackList.count) &&
        equalsNullable(this.next, paginatedRackList.next) &&
        equalsNullable(this.previous, paginatedRackList.previous) &&
