...
@JsonPropertyOrder({
  ...
  Role.JSON_PROPERTY_DISPLAY_URL,
...
public class Role {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, role.id) &&
        ...
        equalsNullable(this.owner, role.owner) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, displayUrl, display, name, slug, weight, description, hashCodeNullable(owner), comments, tags, customFields, created, lastUpdated, prefixCount, vlanCount);
  }
