...
public class PaginatedVMInterfaceList implements Serializable {
  ...
  public PaginatedVMInterfaceList() {
  }

  public PaginatedVMInterfaceList count(@javax.annotation.Nonnull Integer count) {
  ...
  public PaginatedVMInterfaceList addResultsItem(VMInterface resultsItem) {
  ...
  public void setResults(@javax.annotation.Nonnull List<VMInterface> results) {
    this.results = results;
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedVMInterfaceList {\n");
  ...
  public static class Builder {
    ...
    private PaginatedVMInterfaceList instance;

    public Builder() {
      this(new PaginatedVMInterfaceList());
    }

    protected Builder(PaginatedVMInterfaceList instance) {
      this.instance = instance;
    }

    public PaginatedVMInterfaceList.Builder count(Integer count) {
      this.instance.count = count;
      return this;
    }
    public PaginatedVMInterfaceList.Builder next(URI next) {
      this.instance.next = next;
      return this;
    }
    public PaginatedVMInterfaceList.Builder previous(URI previous) {
      this.instance.previous = previous;
      return this;
    }
    public PaginatedVMInterfaceList.Builder results(List<VMInterface> results) {
    ...
    /**
    * returns a built PaginatedVMInterfaceList instance.
    *
    * The builder is not reusable.
    */
    public PaginatedVMInterfaceList build() {
      try {
  ...
  */
  public static PaginatedVMInterfaceList.Builder builder() {
    return new PaginatedVMInterfaceList.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public PaginatedVMInterfaceList.Builder toBuilder() {
    return new PaginatedVMInterfaceList.Builder()
      .count(getCount())
      .next(getNext())
