...
public class ObjectChangeAction implements Serializable {
  ...
  public ObjectChangeAction() {
  }

  public ObjectChangeAction value(@javax.annotation.Nullable ValueEnum value) {
  ...
  public ObjectChangeAction label(@javax.annotation.Nullable LabelEnum label) {
  ...
  public boolean equals(Object o) {
    ...
    ObjectChangeAction objectChangeAction = (ObjectChangeAction) o;
    return Objects.equals(this.value, objectChangeAction.value) &&
        Objects.equals(this.label, objectChangeAction.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class ObjectChangeAction {\n");
  ...
  public static class Builder {
    ...
    private ObjectChangeAction instance;

    public Builder() {
      this(new ObjectChangeAction());
    }

    protected Builder(ObjectChangeAction instance) {
      this.instance = instance;
    }

    public ObjectChangeAction.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public ObjectChangeAction.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built ObjectChangeAction instance.
    *
    * The builder is not reusable.
    */
    public ObjectChangeAction build() {
      try {
  ...
  */
  public static ObjectChangeAction.Builder builder() {
    return new ObjectChangeAction.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public ObjectChangeAction.Builder toBuilder() {
    return new ObjectChangeAction.Builder()
      .value(getValue())
      .label(getLabel());
  }
