...
public class PowerOutletStatus implements Serializable {
  ...
  public static class Builder {
    ...
    private PowerOutletStatus instance;

    public Builder() {
      this(new PowerOutletStatus());
    }

    protected Builder(PowerOutletStatus instance) {
      this.instance = instance;
    }

    public PowerOutletStatus.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public PowerOutletStatus.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built PowerOutletStatus instance.
    *
    * The builder is not reusable.
    */
    public PowerOutletStatus build() {
      try {
  ...
  */
  public static PowerOutletStatus.Builder builder() {
    return new PowerOutletStatus.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public PowerOutletStatus.Builder toBuilder() {
    return new PowerOutletStatus.Builder()
      .value(getValue())
      .label(getLabel());
  }
