...
public class L2VPNStatus implements Serializable {
  ...
  public static class Builder {
    ...
    private L2VPNStatus instance;

    public Builder() {
      this(new L2VPNStatus());
    }

    protected Builder(L2VPNStatus instance) {
      this.instance = instance;
    }

    public L2VPNStatus.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public L2VPNStatus.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built L2VPNStatus instance.
    *
    * The builder is not reusable.
    */
    public L2VPNStatus build() {
      try {
  ...
  */
  public static L2VPNStatus.Builder builder() {
    return new L2VPNStatus.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public L2VPNStatus.Builder toBuilder() {
    return new L2VPNStatus.Builder()
      .value(getValue())
      .label(getLabel());
  }
