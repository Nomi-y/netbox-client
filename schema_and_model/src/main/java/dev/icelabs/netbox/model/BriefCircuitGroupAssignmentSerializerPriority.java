...
public class BriefCircuitGroupAssignmentSerializerPriority implements Serializable {
  ...
  public BriefCircuitGroupAssignmentSerializerPriority() {
  }

  public BriefCircuitGroupAssignmentSerializerPriority value(@javax.annotation.Nullable ValueEnum value) {
  ...
  public BriefCircuitGroupAssignmentSerializerPriority label(@javax.annotation.Nullable LabelEnum label) {
  ...
  public boolean equals(Object o) {
    ...
    BriefCircuitGroupAssignmentSerializerPriority briefCircuitGroupAssignmentSerializerPriority = (BriefCircuitGroupAssignmentSerializerPriority) o;
    return Objects.equals(this.value, briefCircuitGroupAssignmentSerializerPriority.value) &&
        Objects.equals(this.label, briefCircuitGroupAssignmentSerializerPriority.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class BriefCircuitGroupAssignmentSerializerPriority {\n");
  ...
  public static class Builder {
    ...
    private BriefCircuitGroupAssignmentSerializerPriority instance;

    public Builder() {
      this(new BriefCircuitGroupAssignmentSerializerPriority());
    }

    protected Builder(BriefCircuitGroupAssignmentSerializerPriority instance) {
      this.instance = instance;
    }

    public BriefCircuitGroupAssignmentSerializerPriority.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public BriefCircuitGroupAssignmentSerializerPriority.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built BriefCircuitGroupAssignmentSerializerPriority instance.
    *
    * The builder is not reusable.
    */
    public BriefCircuitGroupAssignmentSerializerPriority build() {
      try {
  ...
  */
  public static BriefCircuitGroupAssignmentSerializerPriority.Builder builder() {
    return new BriefCircuitGroupAssignmentSerializerPriority.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public BriefCircuitGroupAssignmentSerializerPriority.Builder toBuilder() {
    return new BriefCircuitGroupAssignmentSerializerPriority.Builder()
      .value(getValue())
      .label(getLabel());
  }
