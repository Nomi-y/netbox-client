...
public class BriefDevice implements Serializable {
  ...
  public static class Builder {
    ...
    private BriefDevice instance;

    public Builder() {
      this(new BriefDevice());
    }

    protected Builder(BriefDevice instance) {
      this.instance = instance;
    }

    public BriefDevice.Builder id(Integer id) {
      this.instance.id = id;
      return this;
    }
    public BriefDevice.Builder url(URI url) {
      this.instance.url = url;
      return this;
    }
    public BriefDevice.Builder display(String display) {
      this.instance.display = display;
      return this;
    }
    public BriefDevice.Builder name(String name) {
      this.instance.name = name;
      return this;
    }
    public BriefDevice.Builder description(String description) {
    ...
    /**
    * returns a built BriefDevice instance.
    *
    * The builder is not reusable.
    */
    public BriefDevice build() {
      try {
  ...
  */
  public static BriefDevice.Builder builder() {
    return new BriefDevice.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public BriefDevice.Builder toBuilder() {
    return new BriefDevice.Builder()
      .id(getId())
      .url(getUrl())
      .display(getDisplay())
