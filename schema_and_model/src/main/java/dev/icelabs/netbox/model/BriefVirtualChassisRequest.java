...
public class BriefVirtualChassisRequest implements Serializable {
  ...
  public BriefVirtualChassisRequest() {
  }

  public BriefVirtualChassisRequest name(@javax.annotation.Nonnull String name) {
  ...
  public String toString() {
    ...
    sb.append("class BriefVirtualChassisRequest {\n");
  ...
  public static class Builder {
    ...
    private BriefVirtualChassisRequest instance;

    public Builder() {
      this(new BriefVirtualChassisRequest());
    }

    protected Builder(BriefVirtualChassisRequest instance) {
      this.instance = instance;
    }

    public BriefVirtualChassisRequest.Builder name(String name) {
      this.instance.name = name;
      return this;
    }
    public BriefVirtualChassisRequest.Builder master(NestedDeviceRequest master) {
      this.instance.master = master;
      return this;
    }
    public BriefVirtualChassisRequest.Builder description(String description) {
    ...
    /**
    * returns a built BriefVirtualChassisRequest instance.
    *
    * The builder is not reusable.
    */
    public BriefVirtualChassisRequest build() {
      try {
  ...
  */
  public static BriefVirtualChassisRequest.Builder builder() {
    return new BriefVirtualChassisRequest.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public BriefVirtualChassisRequest.Builder toBuilder() {
    return new BriefVirtualChassisRequest.Builder()
      .name(getName())
      .master(getMaster())
