...
public class DashboardRequest implements Serializable {
  ...
  public DashboardRequest layout(@javax.annotation.Nullable Object layout) {
  ...
  public DashboardRequest config(@javax.annotation.Nullable Object config) {
  ...
  public boolean equals(Object o) {
    ...
    DashboardRequest dashboardRequest = (DashboardRequest) o;
    return Objects.equals(this.layout, dashboardRequest.layout) &&
        Objects.equals(this.config, dashboardRequest.config);
  }
  ...
  public String toString() {
    ...
    sb.append("class DashboardRequest {\n");
  ...
  public static class Builder {
    ...
    private DashboardRequest instance;

    public Builder() {
      this(new DashboardRequest());
    }

    protected Builder(DashboardRequest instance) {
      this.instance = instance;
    }

    public DashboardRequest.Builder layout(Object layout) {
      this.instance.layout = layout;
      return this;
    }
    public DashboardRequest.Builder config(Object config) {
    ...
    /**
    * returns a built DashboardRequest instance.
    *
  ...
  */
  public DashboardRequest.Builder toBuilder() {
    return new DashboardRequest.Builder()
      .layout(getLayout())
      .config(getConfig());
  }
