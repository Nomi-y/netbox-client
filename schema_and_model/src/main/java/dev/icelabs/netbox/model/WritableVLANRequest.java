...
public class WritableVLANRequest implements Serializable {
  ...
  public static class Builder {
    ...
    private WritableVLANRequest instance;

    public Builder() {
      this(new WritableVLANRequest());
    }

    protected Builder(WritableVLANRequest instance) {
      this.instance = instance;
    }

    public WritableVLANRequest.Builder site(PatchedWritableVLANRequestSite site) {
      this.instance.site = site;
      return this;
    }
    public WritableVLANRequest.Builder group(PatchedWritableVLANRequestGroup group) {
      this.instance.group = group;
      return this;
    }
    public WritableVLANRequest.Builder vid(Integer vid) {
      this.instance.vid = vid;
      return this;
    }
    public WritableVLANRequest.Builder name(String name) {
      this.instance.name = name;
      return this;
    }
    public WritableVLANRequest.Builder tenant(ASNRangeRequestTenant tenant) {
      this.instance.tenant = tenant;
      return this;
    }
    public WritableVLANRequest.Builder status(StatusEnum status) {
      this.instance.status = status;
      return this;
    }
    public WritableVLANRequest.Builder role(IPRangeRequestRole role) {
      this.instance.role = role;
      return this;
    }
    public WritableVLANRequest.Builder description(String description) {
      this.instance.description = description;
      return this;
    }
    public WritableVLANRequest.Builder qinqRole(QinqRoleEnum qinqRole) {
      this.instance.qinqRole = qinqRole;
      return this;
    }
    public WritableVLANRequest.Builder qinqSvlan(Integer qinqSvlan) {
      this.instance.qinqSvlan = qinqSvlan;
      return this;
    }
    public WritableVLANRequest.Builder owner(ASNRangeRequestOwner owner) {
      this.instance.owner = owner;
      return this;
    }
    public WritableVLANRequest.Builder comments(String comments) {
      this.instance.comments = comments;
      return this;
    }
    public WritableVLANRequest.Builder tags(List<NestedTagRequest> tags) {
      this.instance.tags = tags;
      return this;
    }
    public WritableVLANRequest.Builder customFields(Map<String, Object> customFields) {
    ...
    /**
    * returns a built WritableVLANRequest instance.
    *
    * The builder is not reusable.
    */
    public WritableVLANRequest build() {
      try {
  ...
  */
  public static WritableVLANRequest.Builder builder() {
    return new WritableVLANRequest.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public WritableVLANRequest.Builder toBuilder() {
    return new WritableVLANRequest.Builder()
      .site(getSite())
      .group(getGroup())
      .vid(getVid())
