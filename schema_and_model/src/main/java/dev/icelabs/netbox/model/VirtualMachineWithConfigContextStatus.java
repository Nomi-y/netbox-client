...
public class VirtualMachineWithConfigContextStatus implements Serializable {
  ...
  public VirtualMachineWithConfigContextStatus() {
  }

  public VirtualMachineWithConfigContextStatus value(@javax.annotation.Nullable ValueEnum value) {
  ...
  public VirtualMachineWithConfigContextStatus label(@javax.annotation.Nullable LabelEnum label) {
  ...
  public boolean equals(Object o) {
    ...
    VirtualMachineWithConfigContextStatus virtualMachineWithConfigContextStatus = (VirtualMachineWithConfigContextStatus) o;
    return Objects.equals(this.value, virtualMachineWithConfigContextStatus.value) &&
        Objects.equals(this.label, virtualMachineWithConfigContextStatus.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class VirtualMachineWithConfigContextStatus {\n");
  ...
  public static class Builder {
    ...
    private VirtualMachineWithConfigContextStatus instance;

    public Builder() {
      this(new VirtualMachineWithConfigContextStatus());
    }

    protected Builder(VirtualMachineWithConfigContextStatus instance) {
      this.instance = instance;
    }

    public VirtualMachineWithConfigContextStatus.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public VirtualMachineWithConfigContextStatus.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built VirtualMachineWithConfigContextStatus instance.
    *
    * The builder is not reusable.
    */
    public VirtualMachineWithConfigContextStatus build() {
      try {
  ...
  */
  public static VirtualMachineWithConfigContextStatus.Builder builder() {
    return new VirtualMachineWithConfigContextStatus.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public VirtualMachineWithConfigContextStatus.Builder toBuilder() {
    return new VirtualMachineWithConfigContextStatus.Builder()
      .value(getValue())
      .label(getLabel());
  }
