...
public class DataSourceStatus implements Serializable {
  ...
  public static class Builder {
    ...
    private DataSourceStatus instance;

    public Builder() {
      this(new DataSourceStatus());
    }

    protected Builder(DataSourceStatus instance) {
      this.instance = instance;
    }

    public DataSourceStatus.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public DataSourceStatus.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built DataSourceStatus instance.
    *
  ...
  */
  public static DataSourceStatus.Builder builder() {
    return new DataSourceStatus.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public DataSourceStatus.Builder toBuilder() {
    return new DataSourceStatus.Builder()
      .value(getValue())
      .label(getLabel());
  }
