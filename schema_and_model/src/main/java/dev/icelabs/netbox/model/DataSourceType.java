...
public class DataSourceType implements Serializable {
  ...
  public static class Builder {
    ...
    public Builder() {
      this(new DataSourceType());
    }

    protected Builder(DataSourceType instance) {
      this.instance = instance;
    }

    public DataSourceType.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public DataSourceType.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built DataSourceType instance.
    *
  ...
  */
  public static DataSourceType.Builder builder() {
    return new DataSourceType.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public DataSourceType.Builder toBuilder() {
    return new DataSourceType.Builder()
      .value(getValue())
      .label(getLabel());
  }
