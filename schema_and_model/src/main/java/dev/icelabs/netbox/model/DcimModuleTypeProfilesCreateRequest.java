...
public class DcimModuleTypeProfilesCreateRequest implements Serializable {
  ...
  public DcimModuleTypeProfilesCreateRequest() {
  }

  public DcimModuleTypeProfilesCreateRequest name(@javax.annotation.Nonnull String name) {
  ...
  public DcimModuleTypeProfilesCreateRequest description(@javax.annotation.Nullable String description) {
  ...
  public DcimModuleTypeProfilesCreateRequest tags(@javax.annotation.Nullable List<NestedTagRequest> tags) {
    
    this.tags = tags;
    return this;
  }

  public DcimModuleTypeProfilesCreateRequest addTagsItem(NestedTagRequest tagsItem) {
    if (this.tags == null) {
  ...
  public DcimModuleTypeProfilesCreateRequest customFields(@javax.annotation.Nullable Map<String, Object> customFields) {
    
    this.customFields = customFields;
    return this;
  }

  public DcimModuleTypeProfilesCreateRequest putCustomFieldsItem(String key, Object customFieldsItem) {
  ...
  public String toString() {
    ...
    sb.append("class DcimModuleTypeProfilesCreateRequest {\n");
  ...
  public static class Builder {
    ...
    private DcimModuleTypeProfilesCreateRequest instance;

    public Builder() {
      this(new DcimModuleTypeProfilesCreateRequest());
    }

    protected Builder(DcimModuleTypeProfilesCreateRequest instance) {
      this.instance = instance;
    }

    public DcimModuleTypeProfilesCreateRequest.Builder name(String name) {
      this.instance.name = name;
      return this;
    }
    public DcimModuleTypeProfilesCreateRequest.Builder description(String description) {
      this.instance.description = description;
      return this;
    }
    public DcimModuleTypeProfilesCreateRequest.Builder schema(Object schema) {
      this.instance.schema = schema;
      return this;
    }
    public DcimModuleTypeProfilesCreateRequest.Builder owner(ASNRangeRequestOwner owner) {
      this.instance.owner = owner;
      return this;
    }
    public DcimModuleTypeProfilesCreateRequest.Builder comments(String comments) {
      this.instance.comments = comments;
      return this;
    }
    public DcimModuleTypeProfilesCreateRequest.Builder tags(List<NestedTagRequest> tags) {
      this.instance.tags = tags;
      return this;
    }
    public DcimModuleTypeProfilesCreateRequest.Builder customFields(Map<String, Object> customFields) {
    ...
    /**
    * returns a built DcimModuleTypeProfilesCreateRequest instance.
    *
    * The builder is not reusable.
    */
    public DcimModuleTypeProfilesCreateRequest build() {
      try {
  ...
  */
  public static DcimModuleTypeProfilesCreateRequest.Builder builder() {
    return new DcimModuleTypeProfilesCreateRequest.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public DcimModuleTypeProfilesCreateRequest.Builder toBuilder() {
    return new DcimModuleTypeProfilesCreateRequest.Builder()
      .name(getName())
