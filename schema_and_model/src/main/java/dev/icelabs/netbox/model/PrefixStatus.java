...
public class PrefixStatus implements Serializable {
  ...
  public PrefixStatus value(@javax.annotation.Nullable ValueEnum value) {
  ...
  public PrefixStatus label(@javax.annotation.Nullable LabelEnum label) {
  ...
  public boolean equals(Object o) {
    ...
    PrefixStatus prefixStatus = (PrefixStatus) o;
    return Objects.equals(this.value, prefixStatus.value) &&
        Objects.equals(this.label, prefixStatus.label);
  }
  ...
  public static class Builder {
    ...
    private PrefixStatus instance;

    public Builder() {
      this(new PrefixStatus());
    }

    protected Builder(PrefixStatus instance) {
      this.instance = instance;
    }

    public PrefixStatus.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public PrefixStatus.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built PrefixStatus instance.
    *
    * The builder is not reusable.
    */
    public PrefixStatus build() {
      try {
  ...
  */
  public static PrefixStatus.Builder builder() {
    return new PrefixStatus.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public PrefixStatus.Builder toBuilder() {
    return new PrefixStatus.Builder()
      .value(getValue())
      .label(getLabel());
  }
