...
public class NestedDevice implements Serializable {
  ...
  public static class Builder {
    ...
    private NestedDevice instance;

    public Builder() {
      this(new NestedDevice());
    }

    protected Builder(NestedDevice instance) {
      this.instance = instance;
    }

    public NestedDevice.Builder id(Integer id) {
      this.instance.id = id;
      return this;
    }
    public NestedDevice.Builder url(URI url) {
      this.instance.url = url;
      return this;
    }
    public NestedDevice.Builder displayUrl(URI displayUrl) {
      this.instance.displayUrl = displayUrl;
      return this;
    }
    public NestedDevice.Builder display(String display) {
      this.instance.display = display;
      return this;
    }
    public NestedDevice.Builder name(String name) {
    ...
    /**
    * returns a built NestedDevice instance.
    *
    * The builder is not reusable.
    */
    public NestedDevice build() {
      try {
  ...
  */
  public static NestedDevice.Builder builder() {
    return new NestedDevice.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public NestedDevice.Builder toBuilder() {
    return new NestedDevice.Builder()
      .id(getId())
      .url(getUrl())
