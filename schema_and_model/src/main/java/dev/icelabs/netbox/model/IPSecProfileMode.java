...
public class IPSecProfileMode implements Serializable {
  ...
  public IPSecProfileMode() {
  }

  public IPSecProfileMode value(@javax.annotation.Nullable ValueEnum value) {
  ...
  public IPSecProfileMode label(@javax.annotation.Nullable LabelEnum label) {
  ...
  public boolean equals(Object o) {
    ...
    IPSecProfileMode ipSecProfileMode = (IPSecProfileMode) o;
    return Objects.equals(this.value, ipSecProfileMode.value) &&
        Objects.equals(this.label, ipSecProfileMode.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class IPSecProfileMode {\n");
  ...
  public static class Builder {
    ...
    private IPSecProfileMode instance;

    public Builder() {
      this(new IPSecProfileMode());
    }

    protected Builder(IPSecProfileMode instance) {
      this.instance = instance;
    }

    public IPSecProfileMode.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public IPSecProfileMode.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built IPSecProfileMode instance.
    *
    * The builder is not reusable.
    */
    public IPSecProfileMode build() {
      try {
  ...
  */
  public static IPSecProfileMode.Builder builder() {
    return new IPSecProfileMode.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public IPSecProfileMode.Builder toBuilder() {
    return new IPSecProfileMode.Builder()
      .value(getValue())
      .label(getLabel());
  }
