...
public class InterfaceDuplex implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, interfaceDuplex.value) &&
  ...
  public static class Builder {
    ...
    private InterfaceDuplex instance;

    public Builder() {
      this(new InterfaceDuplex());
    }

    protected Builder(InterfaceDuplex instance) {
      this.instance = instance;
    }

    public InterfaceDuplex.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public InterfaceDuplex.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built InterfaceDuplex instance.
    *
    * The builder is not reusable.
    */
    public InterfaceDuplex build() {
      try {
  ...
  */
  public static InterfaceDuplex.Builder builder() {
    return new InterfaceDuplex.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public InterfaceDuplex.Builder toBuilder() {
    return new InterfaceDuplex.Builder()
      .value(getValue())
      .label(getLabel());
  }
