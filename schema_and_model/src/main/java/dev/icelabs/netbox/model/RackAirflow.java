...
public class RackAirflow implements Serializable {
  ...
  public RackAirflow value(@javax.annotation.Nullable ValueEnum value) {
  ...
  public RackAirflow label(@javax.annotation.Nullable LabelEnum label) {
  ...
  public boolean equals(Object o) {
    ...
    RackAirflow rackAirflow = (RackAirflow) o;
    return Objects.equals(this.value, rackAirflow.value) &&
        Objects.equals(this.label, rackAirflow.label);
  }
  ...
  public static class Builder {
    ...
    private RackAirflow instance;

    public Builder() {
      this(new RackAirflow());
    }

    protected Builder(RackAirflow instance) {
      this.instance = instance;
    }

    public RackAirflow.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public RackAirflow.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built RackAirflow instance.
    *
    * The builder is not reusable.
    */
    public RackAirflow build() {
      try {
  ...
  */
  public static RackAirflow.Builder builder() {
    return new RackAirflow.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public RackAirflow.Builder toBuilder() {
    return new RackAirflow.Builder()
      .value(getValue())
      .label(getLabel());
  }
