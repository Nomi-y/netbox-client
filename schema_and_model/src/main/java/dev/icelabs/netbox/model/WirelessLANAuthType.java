...
public class WirelessLANAuthType implements Serializable {
  ...
  public enum LabelEnum {
    ...
    WPA_PERSONAL_PSK_(String.valueOf("WPA Personal (PSK)")),
  ...
  public WirelessLANAuthType() {
  }

  public WirelessLANAuthType value(@javax.annotation.Nullable ValueEnum value) {
  ...
  public WirelessLANAuthType label(@javax.annotation.Nullable LabelEnum label) {
  ...
  public boolean equals(Object o) {
    ...
    WirelessLANAuthType wirelessLANAuthType = (WirelessLANAuthType) o;
    return Objects.equals(this.value, wirelessLANAuthType.value) &&
        Objects.equals(this.label, wirelessLANAuthType.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class WirelessLANAuthType {\n");
  ...
  public static class Builder {
    ...
    private WirelessLANAuthType instance;

    public Builder() {
      this(new WirelessLANAuthType());
    }

    protected Builder(WirelessLANAuthType instance) {
      this.instance = instance;
    }

    public WirelessLANAuthType.Builder value(ValueEnum value) {
      this.instance.value = value;
      return this;
    }
    public WirelessLANAuthType.Builder label(LabelEnum label) {
    ...
    /**
    * returns a built WirelessLANAuthType instance.
    *
    * The builder is not reusable.
    */
    public WirelessLANAuthType build() {
      try {
  ...
  */
  public static WirelessLANAuthType.Builder builder() {
    return new WirelessLANAuthType.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public WirelessLANAuthType.Builder toBuilder() {
    return new WirelessLANAuthType.Builder()
      .value(getValue())
      .label(getLabel());
  }
