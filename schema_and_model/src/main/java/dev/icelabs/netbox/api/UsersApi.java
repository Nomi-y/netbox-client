...
public interface UsersApi {
  ...
  Call<OwnerGroup> usersOwnerGroupsPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedOwnerGroupRequest patchedOwnerGroupRequest);
  ...
  Call<ObjectPermission> usersPermissionsPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedObjectPermissionRequest patchedObjectPermissionRequest);
  ...
  Call<ObjectPermission> usersPermissionsUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body ObjectPermissionRequest objectPermissionRequest);
