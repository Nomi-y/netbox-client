...
public interface VpnApi {
  ...
  Call<IKEPolicy> vpnIkePoliciesPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedWritableIKEPolicyRequest patchedWritableIKEPolicyRequest);
  ...
  Call<IKEPolicy> vpnIkePoliciesUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body WritableIKEPolicyRequest writableIKEPolicyRequest);
  ...
  Call<IKEProposal> vpnIkeProposalsPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedWritableIKEProposalRequest patchedWritableIKEProposalRequest);
  ...
  Call<IKEProposal> vpnIkeProposalsUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body WritableIKEProposalRequest writableIKEProposalRequest);
  ...
  Call<IPSecPolicy> vpnIpsecPoliciesPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedWritableIPSecPolicyRequest patchedWritableIPSecPolicyRequest);
  ...
  Call<IPSecPolicy> vpnIpsecPoliciesUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body WritableIPSecPolicyRequest writableIPSecPolicyRequest);
  ...
  Call<IPSecProfile> vpnIpsecProfilesPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedWritableIPSecProfileRequest patchedWritableIPSecProfileRequest);
  ...
  Call<IPSecProfile> vpnIpsecProfilesUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body WritableIPSecProfileRequest writableIPSecProfileRequest);
  ...
  Call<IPSecProposal> vpnIpsecProposalsPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedWritableIPSecProposalRequest patchedWritableIPSecProposalRequest);
  ...
  Call<IPSecProposal> vpnIpsecProposalsUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body WritableIPSecProposalRequest writableIPSecProposalRequest);
  ...
  Call<L2VPNTermination> vpnL2vpnTerminationsPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedL2VPNTerminationRequest patchedL2VPNTerminationRequest);
  ...
  Call<L2VPNTermination> vpnL2vpnTerminationsUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body L2VPNTerminationRequest l2VPNTerminationRequest);
  ...
  Call<L2VPN> vpnL2vpnsPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedWritableL2VPNRequest patchedWritableL2VPNRequest);
  ...
  Call<TunnelGroup> vpnTunnelGroupsPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedTunnelGroupRequest patchedTunnelGroupRequest);
  ...
  Call<TunnelTermination> vpnTunnelTerminationsPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedWritableTunnelTerminationRequest patchedWritableTunnelTerminationRequest);
  ...
  Call<TunnelTermination> vpnTunnelTerminationsUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body WritableTunnelTerminationRequest writableTunnelTerminationRequest);
  ...
  Call<Tunnel> vpnTunnelsPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedWritableTunnelRequest patchedWritableTunnelRequest);
