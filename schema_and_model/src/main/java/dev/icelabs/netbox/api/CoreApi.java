...
public interface CoreApi {
  ...
  Call<DataSource> coreDataSourcesPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedWritableDataSourceRequest patchedWritableDataSourceRequest);
  ...
  Call<DataSource> coreDataSourcesSyncCreate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body WritableDataSourceRequest writableDataSourceRequest);
