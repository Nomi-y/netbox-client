...
public interface TenancyApi {
  ...
  Call<ContactAssignment> tenancyContactAssignmentsPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedWritableContactAssignmentRequest patchedWritableContactAssignmentRequest);
  ...
  Call<ContactAssignment> tenancyContactAssignmentsUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body WritableContactAssignmentRequest writableContactAssignmentRequest);
  ...
  Call<ContactGroup> tenancyContactGroupsPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedWritableContactGroupRequest patchedWritableContactGroupRequest);
  ...
  Call<ContactGroup> tenancyContactGroupsUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body WritableContactGroupRequest writableContactGroupRequest);
  ...
  Call<ContactRole> tenancyContactRolesPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedContactRoleRequest patchedContactRoleRequest);
  ...
  Call<TenantGroup> tenancyTenantGroupsPartialUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body PatchedWritableTenantGroupRequest patchedWritableTenantGroupRequest);
  ...
  Call<TenantGroup> tenancyTenantGroupsUpdate(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body WritableTenantGroupRequest writableTenantGroupRequest);
